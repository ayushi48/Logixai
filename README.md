...
<a href="https://logixai-two.vercel.app/">
  <img src="https://img.shields.io/badge/🚀_Live_Demo-A855F7?style=for-the-badge&logoColor=white&labelColor=EC4899" />
</a>
...
<a href="https://ayushikumari.me/">
  <img src="https://img.shields.io/badge/👤_Portfolio-EC4899?style=for-the-badge&logoColor=white&labelColor=A855F7" />
</a>

<br/><br/>

<img src="https://skillicons.dev/icons?i=react,tailwind,nodejs,express,mongodb,vite,javascript,vercel&theme=dark" />
...
<img src="https://img.shields.io/badge/IMAGES-CLOUDINARY-3448C5?style=for-the-badge&logo=cloudinary&logoColor=white" />
<img src="https://img.shields.io/badge/BG_REMOVAL-REMOVE.BG-FF5B5B?style=for-the-badge&logoColor=white" />
...
```mermaid
graph TB
    USER([👤 User]) --> UI[🖥️ React Frontend]

    subgraph MODULES["🧩 Feature Modules"]
        CHAT[🤖 AI Chat Assistant]
        BUILD[🏗️ Website Builder]
        CONV[🖼️ Image Converter]
        BG[✂️ Background Remover]
    end
    ...
    API --> IMGSVC[🖼️ Image Processing Service]

    AISVC -->|prompts & responses| GEMINI[(Google Gemini API)]
    IMGSVC -->|background removal| REMOVEBG[(remove.bg API)]
    IMGSVC -->|storage| CLOUD[☁️ Cloudinary]
    AUTH --> DB[(MongoDB)]
```
...
```mermaid
graph LR
    A[📤 Image Uploaded] --> B[🖼️ Processed / BG Removed]
    B --> C[☁️ Stored on Cloudinary]
    C --> D[⏱️ setTimeout Expiry Timer]
    D --> E[🗑️ Auto-Deleted from Cloudinary]
```
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:6366F1,50:EC4899,100:A855F7&height=120&section=footer"/>
